var goodsList = [{
		id: 1234564876,
		imgUrl: 'images/goods/2018110101.jpg',
	...
	{
		id: 1234564876,
		imgUrl: 'images/goods/2018110102.jpg',
		goodsInfo: '号地块健身房回复的科技示范户快速坚实的看了看大家发快递了很费劲的开始放假',
		goodsParams: '四季度后付款的酸辣粉',
		price: 299,
		goodsCount: 2,
	...
	{
		id: 1234564876,
		imgUrl: 'images/goods/2018110103.jpg',
		goodsInfo: '号地块健身房回复的科技示范户快速坚实的看了看大家发快递了很费劲的开始放假',
		goodsParams: '四季度后付款的酸辣粉',
		price: 399,
		goodsCount: 1,
...
function loadGoods() {
	$.each(goodsList, function(i, item) {
		var goodsHtml = '<div class="goods-item">' +
			...
			'</div>' +
			'<div class="col-md-5 car-goods-info goods-image-column">' +
...
//			'<div class="col-md-3 car-goods-info goods-params">' + item.goodsParams + '</div>' +
			'<div class="col-md-1 car-goods-info goods-price"><span>￥</span><span class="single-price">' + toDecimal2(item.price) + '</span></div>' +
			...
			'</div>' +
			'</div>' +
			'<div class="col-md-1 car-goods-info goods-money-count"><span>￥</span><span class="single-total">' + toDecimal2(item.singleGoodsMoney) + '</span></div>' +
		...
		if(this.elInput) {
			if(this.isAdd) {
				...
				if(isChecked) {
					...
					$('#selectGoodsCount').empty().append(toDecimal2(goodsTotalCount + 1))
				}
			} else {
...
$(document).on('click','#deleteMulty', function() {
...
$(document).on('click','.deleteMultySure', function() {
